...
const CartModal = () => {
  ...
  return (
    <>
      ...
      {/* Modal */}
      <div className="fixed right-0 top-0 h-full w-full sm:max-w-md bg-background border-l border-border shadow-lg z-50 flex flex-col animate-in slide-in-from-right duration-300">
        {/* Header */}
