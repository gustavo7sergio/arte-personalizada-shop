...
import logoWhite from "@/assets/logo-white.png?format=webp&w=240&imagetools";
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
          <a href="https://wa.me/553584181096?text=Ol%C3%A1!%20Gostaria%20de%20saber%20mais%20sobre%20os%20produtos." target="_blank" rel="noopener noreferrer">
            <Button className="rounded-full font-body font-semibold px-8 py-5 text-base" style={{ backgroundColor: "hsl(4, 42%, 70%)", color: "hsl(var(--rose-foreground))" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="text-left">
            ...
            <ul className="space-y-2 font-body text-sm">
              {["Cartões", "Tags", "Sacolinhas", "Adesivos", "Banners"].map((item) => (
                <li key={item}>
                  <a href="#produtos" className="text-primary-foreground/90 hover:text-primary-foreground transition-colors">
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div className="text-left">
            ...
            <ul className="space-y-3 font-body text-sm">
              <li className="flex items-center justify-start gap-2 text-primary-foreground/90">
        ...
        <div className="border-t border-primary-foreground/10 mt-10 pt-8 text-left md:text-center">
          <p className="text-primary-foreground/90 text-sm font-body">
            © 2026 GS Cartões. Todos os direitos reservados.
          </p>
          <p className="text-primary-foreground/85 text-xs font-body mt-2">
