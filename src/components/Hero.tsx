    ...
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="relative container mx-auto px-6 py-20">
        <div className="max-w-2xl space-y-6">
          ...
          <p className="text-lg md:text-xl text-primary-foreground/80 font-body max-w-lg animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
            Materiais gráficos personalizados com acabamento premium. 
            Pedido mínimo acessível, entrega para todo o Brasil e preço tabelado transparente.
          </p>
