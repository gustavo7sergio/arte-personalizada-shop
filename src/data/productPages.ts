...
export const productPages: ProductPageConfig[] = [
  ...
  },
  {
    ...
    displayName: "Kit Completo 1",
    categorySlug: "kits-de-tags-para-semijoias",
    categoryLabel: "Kits",
    seoTitle: "Kit Completo 1 - Tags e Certificados Personalizados | GS Cartões",
    seoDescription: "Kit Completo 1 com 800 materiais gráficos personalizados: tags e certificados de garantia. Combo completo para marcas de semijoias.",
    longDescription: [
  ...
  },
  {
    ...
    displayName: "Kit Completo 2",
    categorySlug: "kits-de-tags-para-semijoias",
    categoryLabel: "Kits",
    seoTitle: "Kit Completo 2 - Tags e Certificados em Volume | GS Cartões",
    seoDescription: "Kit Completo 2 com 6 mil materiais gráficos personalizados: tags e certificados de garantia em grande volume para marcas consolidadas.",
    longDescription: [
