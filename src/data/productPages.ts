...
export const productPages: ProductPageConfig[] = [
  ...
  },
  {
    ...
    seoDescription: "Kit Essencial 2 com 300 tags personalizadas para brincos, trio e conjuntos. Estoque versátil e artes exclusivas para semijoias.",
    longDescription: [
      "O Kit Essencial 2 reúne três formatos de tags indispensáveis para marcas de semijoias que trabalham com brincos, trio de brincos e conjuntos. É uma opção prática para manter um estoque versátil com excelente custo-benefício.",
      "Todos os materiais são produzidos com artes 100% personalizadas, permitindo que cada modelo tenha uma arte diferente, de acordo com a identidade da sua marca. O kit mantém apenas os formatos, medidas, cortes e furos pré-definidos.",
      "Produzido em papel couchê 250g, com impressão colorida frente e verso e brilho total na frente, oferece acabamento profissional e uma apresentação elegante para suas peças.",
    ],
    faqs: wrapFaqs([
      { q: "O que está incluso neste kit?", a: "Este kit inclui exatamente os modelos e quantidades informados na descrição do produto. Os formatos, medidas, cortes e furos já fazem parte da composição do kit." },
      { q: "As artes são personalizadas?", a: "Sim. Todos os materiais são produzidos com artes 100% personalizadas." },
      { q: "Cada modelo pode ter uma arte diferente?", a: "Sim. Você pode utilizar uma arte diferente para cada modelo do kit, sem custo adicional. O que permanece fixo são apenas os formatos, medidas, cortes e furos." },
      { q: "Posso alterar o tamanho das tags?", a: "Não. Os tamanhos são fixos e fazem parte da composição do kit." },
      { q: "Posso alterar os furos ou cortes das tags?", a: "Não. Os modelos do kit possuem cortes e furos padronizados e não podem ser modificados." },
      { q: "Vocês criam a arte?", a: "Sim. Caso ainda não tenha a arte pronta, nossa equipe pode desenvolver o layout para você. Basta entrar em contato para solicitar um orçamento." },
      { q: "Posso usar minha própria logo?", a: "Sim. Você pode enviar sua logo, cores e demais informações da marca para que todos os materiais sejam personalizados." },
      { q: "Qual é o prazo de produção?", a: "O prazo de produção é de 5 a 6 dias úteis após a aprovação da arte." },
      { q: "Qual é o prazo de entrega?", a: "O prazo de entrega varia conforme o CEP e a modalidade de frete escolhida no carrinho." },
      { q: "Quais formas de pagamento vocês aceitam?", a: "Aceitamos PIX com 10% de desconto e cartão de crédito em até 6x sem juros." },
      { q: "Vocês enviam para todo o Brasil?", a: "Sim. Enviamos para qualquer região do Brasil." },
      { q: "As cores impressas ficam exatamente iguais às da tela?", a: "Não. Não trabalhamos com fidelização de cores. Pequenas variações podem ocorrer devido às diferenças entre telas, arquivos e processos gráficos." },
    ]),
  },
  {
    ...
    longDescription: [
      "O Kit Essencial 3 é ideal para marcas que trabalham com anéis e desejam manter um estoque completo dos principais modelos de tags. Além das tags tradicionais, o kit já inclui mini tags para anéis, oferecendo mais praticidade na apresentação das suas peças.",
      "Todos os materiais são produzidos com artes 100% personalizadas, permitindo que cada modelo tenha uma arte diferente, de acordo com a identidade da sua marca. O kit mantém apenas os formatos, medidas, cortes e furos pré-definidos.",
      "Produzido em papel couchê 250g, com impressão colorida frente e verso e brilho total na frente, garante acabamento profissional e excelente custo-benefício.",
    ],
    faqs: wrapFaqs([
      { q: "O que está incluso neste kit?", a: "Este kit inclui exatamente os modelos e quantidades informados na descrição do produto. Os formatos, medidas, cortes e furos já fazem parte da composição do kit." },
      { q: "As artes são personalizadas?", a: "Sim. Todos os materiais são produzidos com artes 100% personalizadas." },
  ...
  },
  {
    ...
    seoDescription: "Kit Essencial 4 com 300 tags personalizadas para brincos, trios de brincos e conjuntos. Formatos fixos e artes 100% exclusivas.",
    longDescription: [
      "O Kit Essencial 4 reúne os principais modelos de tags para marcas que trabalham com brincos, trios de brincos e conjuntos. A combinação dos formatos permite apresentar diferentes tipos de peças mantendo uma identidade visual profissional.",
      "Todos os materiais são produzidos com artes 100% personalizadas, permitindo que cada modelo tenha uma arte diferente, de acordo com a identidade da sua marca. O kit mantém apenas os formatos, medidas, cortes e furos pré-definidos.",
      "Produzido em papel couchê 250g, com impressão colorida frente e verso e brilho total na frente, oferece acabamento de alta qualidade e excelente custo-benefício.",
    ],
    faqs: wrapFaqs([
      { q: "O que está incluso neste kit?", a: "Este kit inclui exatamente os modelos e quantidades informados na descrição do produto. Os formatos, medidas, cortes e furos já fazem parte da composição do kit." },
      { q: "As artes são personalizadas?", a: "Sim. Todos os materiais são produzidos com artes 100% personalizadas." },
  ...
  // ─────────── PAPELARIA ───────────
  {
    ...
    longDescription: [
      "O Bloco de Pedidos Personalizado é a solução ideal para organizar vendas, encomendas e atendimentos de forma prática e profissional. Personalizado com a identidade da sua marca, ele facilita o preenchimento das informações do cliente e transmite mais credibilidade no atendimento.",
      "Cada bloco possui 100 folhas destacáveis, perfeito para registrar pedidos, acompanhar entregas e manter um histórico organizado do seu negócio.",
      "Disponível em duas versões: colorido em papel sulfite 90g e preto e branco em papel sulfite 75g. A impressão é realizada somente na frente das folhas.",
    ],
    faqs: wrapFaqs([
      { q: "O bloco é personalizado?", a: "Sim. Desenvolvemos o bloco com a identidade visual da sua marca, incluindo logo, cores e as informações que desejar." },
      { q: "Posso alterar o layout do bloco?", a: "Sim. Como a arte é personalizada, é possível adaptar campos, incluir observações, contatos, redes sociais e outras informações conforme sua necessidade." },
      { q: "Quantas folhas vêm em cada bloco?", a: "Cada bloco possui 100 folhas destacáveis." },
      { q: "A impressão é frente e verso?", a: "Não. A impressão é realizada apenas na frente das folhas." },
      { q: "Qual a diferença entre as versões?", a: "A versão colorida é produzida em papel sulfite 90g. A versão preto e branco é produzida em papel sulfite 75g." },
      { q: "Vocês criam a arte?", a: "Sim. Caso ainda não tenha um layout, nossa equipe pode desenvolver a arte personalizada para você." },
      { q: "Posso enviar minha própria arte?", a: "Sim. Você pode enviar o arquivo pronto ou apenas sua logo e as informações para personalização." },
      { q: "Qual é o prazo de produção?", a: "O prazo de produção é de 5 a 6 dias úteis após a aprovação da arte." },
      { q: "Qual é o prazo de entrega?", a: "O prazo varia conforme o CEP e a modalidade de frete escolhida no carrinho." },
      { q: "Quais formas de pagamento vocês aceitam?", a: "Aceitamos PIX com 10% de desconto e cartão de crédito em até 6x sem juros." },
      { q: "Vocês enviam para todo o Brasil?", a: "Sim. Enviamos para qualquer região do Brasil." },
      { q: "As cores impressas ficam exatamente iguais às da tela?", a: "Não. Não trabalhamos com fidelização de cores, podendo ocorrer pequenas variações entre a arte visualizada na tela e o material impresso." },
    ]),
  },
  {
    ...
    longDescription: [
      "O Panfleto Personalizado é uma forma prática e econômica de divulgar sua marca, produtos, serviços, promoções e eventos. Ideal para distribuir em lojas, feiras, ações promocionais e junto aos pedidos, ele amplia o alcance da sua comunicação de forma profissional.",
      "A impressão é realizada em alta qualidade e cada panfleto é desenvolvido com a identidade visual da sua empresa, garantindo uma apresentação alinhada à sua marca.",
      "O tamanho e o papel variam conforme a quantidade escolhida, oferecendo o melhor custo-benefício para cada tiragem.",
    ...
    faqs: wrapFaqs([
      { q: "O panfleto é personalizado?", a: "Sim. Desenvolvemos a arte com a identidade visual da sua empresa ou utilizamos o arquivo enviado por você." },
      { q: "Posso enviar minha própria arte?", a: "Sim. Caso já tenha o layout pronto, basta enviá-lo após a compra." },
      { q: "Vocês criam a arte?", a: "Sim. Caso não tenha a arte pronta, nossa equipe pode desenvolver um layout personalizado." },
      { q: "Qual a diferença entre as quantidades?", a: "Até 500 unidades, os panfletos são produzidos no tamanho 10 × 15 cm em papel couché 120g. A partir de 1.000 unidades, são produzidos em 10 × 14 cm no papel couché 90g." },
      { q: "A impressão é frente e verso?", a: "Não. A impressão é realizada apenas na frente." },
      { q: "Os panfletos possuem brilho?", a: "Não. O acabamento é sem brilho." },
      { q: "Existe quantidade mínima?", a: "Sim. A quantidade mínima é de 100 unidades." },
      { q: "Vocês enviam para todo o Brasil?", a: "Sim. Enviamos para qualquer região do Brasil." },
      { q: "A partir de qual quantidade o frete é grátis?", a: "O frete é gratuito para pedidos a partir de 1.000 unidades." },
      { q: "Quais formas de pagamento vocês aceitam?", a: "Aceitamos PIX com 10% de desconto e cartão de crédito em até 6x sem juros." },
      { q: "Qual é o prazo de produção?", a: "O prazo de produção é de 5 a 6 dias úteis após a aprovação da arte." },
      { q: "As cores impressas ficam exatamente iguais às da tela?", a: "Não. Não trabalhamos com fidelização de cores, podendo ocorrer pequenas variações entre a visualização na tela e o material impresso." },
    ]),
  },
  {
