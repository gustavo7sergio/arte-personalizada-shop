...
export const productPages: ProductPageConfig[] = [
  ...
  },
  {
    ...
    seoDescription: "Sacola personalizada para acessórios em papel cartão 300g, 21x15x7 cm, com alças de cordão. Acabamento sofisticado para a sua marca de semijoias.",
    longDescription: [
      "A Sacola Personalizada para Acessórios 21x15x7 cm é ideal para transportar semijoias, acessórios e outros produtos com mais praticidade e segurança. Seu tamanho permite acomodar diferentes itens, sendo uma excelente opção para entregas, presentes e compras com mais de uma peça.",
      "Produzida em papel cartão 300g, possui estrutura reforçada e alças de cordão, oferecendo maior resistência durante o transporte.",
      "A arte é totalmente personalizada na parte externa com a identidade visual da sua marca, permitindo incluir logo, cores, informações de contato, QR Code e outros elementos personalizados.",
      "Caso tenha dúvidas se este tamanho atende aos produtos que você vende, nossa equipe pode ajudar você a escolher o modelo mais adequado.",
    ],
    faqs: [
      { q: "Quais produtos cabem nessa sacola?", a: "Ela é indicada para transportar diferentes tipos de acessórios, semijoias e outros produtos. Caso tenha dúvidas sobre a capacidade da sacola, nossa equipe pode orientar você na escolha do modelo ideal." },
      { q: "A sacola acompanha alças?", a: "Sim. Este modelo possui alças de cordão." },
      ...
      { q: "Qual o material da sacola?", a: "Este modelo é produzido em papel cartão 300g, proporcionando uma estrutura firme e resistente para o transporte dos produtos." },
      { q: "Qual o prazo de produção?", a: "O prazo de produção é de 5 a 6 dias úteis após a aprovação da arte." },
      { q: "Como funciona o pagamento?", a: "Você pode pagar em até 6x sem juros no cartão ou aproveitar 10% de desconto no pagamento via PIX." },
    ],
  },
