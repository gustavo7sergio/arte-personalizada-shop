...
export const productPages: ProductPageConfig[] = [
  ...
  {
    slug: "tag-de-anel-padronizada-3-9x1-7-cm",
    productIds: ["tag-anel-padronizada-pequena"],
    displayName: "Tag de Anel Padronizada 3,9x1,7 cm",
    categorySlug: "tags-personalizadas-para-semijoias",
    categoryLabel: "Tags para Semijoias",
    seoTitle: "Tag de Anel Padronizada 3,9x1,7 cm | GS Cartões",
    seoDescription: "Tag de anel padronizada 3,9x1,7 cm. Formato fixo, preço otimizado e ótima qualidade de impressão.",
    longDescription: [
      "Versão padronizada da nossa tag de anel, com preço otimizado para quem trabalha com grandes volumes e quer manter o visual profissional.",
      "Couchê 250g, frente e verso coloridos e brilho total na frente. Não permite alteração de cortes e furos.",
    ],
    faqs: wrapFaqs([{ q: "Posso pedir furo nesse modelo?", a: "Não. Para furos e cortes personalizados, use a Tag de Anel sob medida." }]),
  },
  {
  ...
  },
  {
    ...
    productIds: ["adesivo-redondo"],
    displayName: "Adesivo Redondo Personalizado",
    categorySlug: "adesivos-personalizados-para-semijoias",
    categoryLabel: "Adesivos",
    seoTitle: "Adesivo Redondo Personalizado | GS Cartões",
    seoDescription: "Adesivo redondo personalizado 3x3 ou 4,8x4,8 cm para embalagens. Reforce sua marca em sacolas, caixinhas e cartões.",
    longDescription: [
      "Versátil e funcional, o adesivo redondo personalizado é perfeito para fechar embalagens, decorar cartões e reforçar a marca em qualquer ponto da entrega.",
      "Papel couchê 80g, frente colorida e sem brilho. Disponível nos tamanhos 3x3 cm e 4,8x4,8 cm.",
    ],
