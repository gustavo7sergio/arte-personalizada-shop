...
export const productPages: ProductPageConfig[] = [
  ...
  },
  {
    ...
    longDescription: [
      ...
      "• Não trabalhamos com fidelização de cores",
      "• Não é possível alterar os formatos, medidas, cortes ou furos dos modelos que compõem o kit",
      "• Kit inclui: 100 Tags 4,25 × 4,8 cm (2 furos), 100 Tags 4,25 × 4,8 cm (6 furos), 100 Tags 8,8 × 4,8 cm",
      "• Prazo de produção: 5 a 6 dias úteis após a aprovação da arte",
    ],
    faqs: wrapFaqs([
  ...
  },
  {
    ...
    longDescription: [
      ...
      "• Não é possível alterar os formatos, medidas, cortes ou furos dos modelos que compõem o kit",
      "Kit inclui:",
      "• 200 Mini Tags para Anel 3,9 × 1,7 cm",
      "• 100 Tags 4,25 × 4,8 cm",
      "• 100 Tags 8,8 × 4,8 cm",
      "• Prazo de produção: 5 a 6 dias úteis após a aprovação da arte",
    ],
  ...
  },
  {
    ...
    longDescription: [
      ...
      "• Não trabalhamos com fidelização de cores",
      "• Não é possível alterar os formatos, medidas, cortes ou furos dos modelos que compõem o kit",
      "• Kit inclui: 100 Tags 4,25 × 4,8 cm (2 furos), 100 Tags 4,25 × 4,8 cm (6 furos), 100 Tags 8,8 × 4,8 cm (6 furos)",
      "• Prazo de produção: 5 a 6 dias úteis após a aprovação da arte",
    ],
    faqs: wrapFaqs([
      { q: "O que está incluso neste kit?", a: "Este kit inclui exatamente os modelos e quantidades informados na descrição do produto. Os formatos, medidas, cortes e furos já fazem parte da composição do kit." },
